...
low dose simulation
model 1: 3 residual blocks, 2 skip connections
...
csv_logger = CSVLogger(csvlogger_path+'model_rb3_l1_adam001_training.csv')

checkpoint_path = "/home/lxia/LDSimulation/DL/checkpoint/"
if not os.path.exists(checkpoint_path):
    os.makedirs(checkpoint_path)

filepath = checkpoint_path+"model_rb3_l1_adam001_{epoch:02d}_{accuracy:.4f}.hdf5"
...
plt.title('accuracy curve, 2 skip connections, 3 residual blocks, adam (0.01), MAE')
plt.ylabel('accuracy')
plt.xlabel('epoch')
plt.savefig(performance_path+"accuracy curve_3rb_adam001_mae.png")
plt.show()

plt.plot(hist.history['loss'])
plt.title('loss curve, 3 residual blocks, adam (0.01), MAE')
plt.ylabel('loss')
plt.xlabel('epoch')
plt.savefig(performance_path+"loss curve_3rb_adam001_mae.png")
plt.show()
...
plt.imsave('test_3rb_adam001_l1_ep1000.png',imgs120_test20,cmap="gray")

x=np.expand_dims(imgs120_test20,axis=0)
output=model.predict(x)

plt.figure(figsize = (20,20))
plt.imsave('output_3rb_adam001_l1_ep1000.png',np.squeeze(output[0],axis=(2,)),cmap="gray")

plt.figure(figsize = (20,20))
plt.imsave('output_diff_3rb_adam001_l1_ep1000.png',np.squeeze(output[0],axis=(2,))-imgs120_test20,cmap="gray")

imgs80_test20=imgs80_test[20]
plt.figure(figsize = (20,20))
plt.imsave('goal_3rb_adam001_l1_ep1000.png',imgs80_test20,cmap="gray")

plt.figure(figsize = (20,20))
plt.imshow('goal_diff_3rb_adam001_l1_ep1000.png',imgs120_test20-imgs80_test20,cmap="gray")
